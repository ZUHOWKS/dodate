...
print_info "  echo 'deb [signed-by=/usr/share/keyrings/dodate.gpg] http://$(hostname -I | awk '{print $1}'):$APT_PORT/apt dodate main' | sudo tee /etc/apt/sources.list.d/dodate.list"
